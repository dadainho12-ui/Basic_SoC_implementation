...
# Generated on: Wed Jul 08 02:23:56 KST 2026 (Tue Jul 07 17:23:56 UTC 2026)
...
set logfile fv/mux/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mux -revised fv_map
...
add_search_path /home/hah002/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/1_MUX -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah002/Basic_SoC_implementation/1_RTL/4_COMB_LOGIC/1_MUX/mux.v
elaborate_design -golden -root {mux} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mux/fv_map.v.gz
elaborate_design -revised -root {mux}
...
set_system_mode lec
write_compared_points noneq.compared_points.mux.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mux.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mux.rtl.fv_map.rpt
