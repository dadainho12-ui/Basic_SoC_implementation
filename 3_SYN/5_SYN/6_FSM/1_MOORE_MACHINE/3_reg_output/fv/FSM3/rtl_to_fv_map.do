...
# Generated on: Wed Jul 08 05:57:46 KST 2026 (Tue Jul 07 20:57:46 UTC 2026)
...
set logfile fv/FSM3/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/FSM3 -revised fv_map
...
add_search_path /home/hah002/Basic_SoC_implementation/1_RTL/6_FSM/1_MOORE_MACHINE/3_reg_output -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah002/Basic_SoC_implementation/1_RTL/6_FSM/1_MOORE_MACHINE/3_reg_output/FSM3.v
elaborate_design -golden -root {FSM3} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/FSM3/fv_map.v.gz
elaborate_design -revised -root {FSM3}
...
#add_name_alias fv/FSM3/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.FSM3.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.FSM3.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.FSM3.rtl.fv_map.rpt
