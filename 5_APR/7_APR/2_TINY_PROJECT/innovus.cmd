...
#  Created on Thu Jul  9 19:17:47 2026                
#                                                     
#######################################################
...
read_mmmc traffic_light.view
#@ Begin verbose source traffic_light.view (pre)
create_library_set -name max_timing\
   -timing /home/hah002/Basic_SoC_implementation/5_APR/1_LIB/slow_vdd1v0_basicCells.lib
create_library_set -name min_timing\
   -timing /home/hah002/Basic_SoC_implementation/5_APR/1_LIB/fast_vdd1v0_basicCells.lib
...
create_rc_corner -name rccorners\
   -cap_table /home/hah002/Basic_SoC_implementation/5_APR/4_CAP_TABLE/cln28hpl_1p10m+alrdl_5x2yu2yz_typical.capTbl\
   -pre_route_res 1\
   -post_route_res 1\
   -pre_route_cap 1\
   -post_route_cap 1\
   ...
   -qrc_tech /home/hah002/Basic_SoC_implementation/5_APR/5_QRC_TECH/gpdk045.tch
...
create_constraint_mode -name sdc_cons\
   -sdc_files\
    /home/hah002/Basic_SoC_implementation/5_APR/2_CONSTRAINTS/2_TINY_PROJECT/traffic_light_final.sdc
...
#@ End verbose source traffic_light.view
...
gui_select -point {15.73700 6.97900}
gui_select -point {16.28850 6.91300}
...
set_db check_drc_report traffic_light.drc.rpt
set_db check_drc_limit 1000
check_drc
set_db check_drc_area {0 0 0 0}
gui_select -point {3.34650 6.49400}
ls
cd ..
ls
